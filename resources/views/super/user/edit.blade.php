        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form form-horizontal" action="{{ '/super/user/edit/'.$user->id }}"
                            method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="namatempat" value="{{ $user->namatempat }}">
                                    </div>
                                    <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="maps" value="{{ $user->maps }}">
                                    </div>
