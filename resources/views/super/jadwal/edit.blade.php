                ...
                <div class="card-content">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form form-horizontal"
                            action="{{ '/super/jadwal/edit/'.$jadwal->id }}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="form-select" name="user_id" id="user_id"
                                                ...
                                                @foreach ($user as $item)
                                                    <option value="{{ $item->id }}" {{($jadwal->user_id === $item->id) ? 'Selected' : ''}}>{{ $item->namatempat }}</option>
                                                @endforeach
                                            </select>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-9 form-group">
                                        <fieldset class="form-group">
                                            <select class="form-select" name="olahraga_id" id="olahraga_id" onchange="updateLapangan()">
