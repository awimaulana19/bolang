        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form form-horizontal" action="{{url('/super/jenis/edit/'.$olahraga->id)}}" method="POST">
                            @csrf 
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 form-group">
                                        <fieldset class="form-group">
                                            <select class="form-select" name="user_id" id="basicSelect">
                                                ...
                                                <option value="{{ $item->id }}" {{($olahraga->user_id === $item->id) ? 'Selected' : ''}}>{{ $item->namatempat }}</option>
                                                @endforeach
                                            </select>
                                        </fieldset>
                                    </div>
