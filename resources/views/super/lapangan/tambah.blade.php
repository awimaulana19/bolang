        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form form-horizontal" action="/super/lapangan/tambah" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9 form-group">
                                        <input type="text" id="nama" class="form-control" name="nama_lapangan" placeholder="Nama Lapangan">
                                    </div>
                                    ...
                                    <div class="col-md-9 form-group">
                                        <fieldset class="form-group">
                                            <select class="form-select" name="olahraga_id" id="olahraga_id" disabled>
