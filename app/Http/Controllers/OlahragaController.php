...
class OlahragaController extends Controller
{
    ...
    public function tambahSuper()
    {
        ...
        return view('super.jenis.tambah', compact('user'));
    }
    ...
    public function operasionalSuper($id)
    {
        $olahraga = Olahraga::where('id', $id)->first();
        $operasionalsenin = Operasional::where('olahraga_id', $olahraga->id)
                                            ->where('hari', "Senin")
        ...
        return view('super.jenis.jam', compact('olahraga', 'operasionalsenin', 'operasionalselasa', 'operasionalrabu', 'operasionalkamis', 'operasionaljumat', 'operasionalsabtu', 'operasionalminggu'));
    }
    ...
    public function editSuper($id)
    {
        $olahraga = Olahraga::where('id', $id)->first();
        $user = User::where('roles', 'admin')->get();
        return view('super.jenis.edit', compact('olahraga', 'user'));
    }
    ...
    public function updateSuper(Request $request, $id)
    {
        ...
        $olahraga->user_id = $request->user_id;
        $olahraga->jenis = $request->jenis;
        $olahraga->deskripsi = $request->input('deskripsi');
        $olahraga->aturan = $request->input('aturan');
        $olahraga->parkiran = $request->input('parkiran') ? true : false;
    ...
    public function storeOperasional(Request $request, $id)
    {
        ...
        if ($operasional->isEmpty()) {
            ...
            if ($seninbuka == "0") {
                ...
                $operasionalsenin->user_id = $olahraga->user_id;
            ...
            if ($selasabuka == "0") {
                ...
                $operasionalselasa->user_id = $olahraga->user_id;
            ...
            if ($rabubuka == "0") {
                ...
                $operasionalrabu->user_id = $olahraga->user_id;
            ...
            if ($kamisbuka == "0") {
                ...
                $operasionalkamis->user_id = $olahraga->user_id;
            ...
            if ($jumatbuka == "0") {
                ...
                $operasionaljumat->user_id = $olahraga->user_id;
            ...
            if ($sabtubuka == "0") {
                ...
                $operasionalsabtu->user_id = $olahraga->user_id;
            ...
            if ($minggubuka == "0") {
                ...
                $operasionalminggu->user_id = $olahraga->user_id;
    ...
    public function storeOperasionalSuper(Request $request, $id)
    {
        $olahraga = Olahraga::where('id', $id)->first();
        $operasional = Operasional::where('olahraga_id', $olahraga->id)->get();
        ...
        return redirect('super/jenis/edit/'.$olahraga->id);
    }
